...
<div class="info-box important">
    ...
    <div>
        ...
        <p>GitHub ve GitLab gibi platformlar, imzalı commit’leri otomatik olarak doğrular ve “Verified” etiketiyle işaretler. Bu, güvenilirliğinizi artırır.</p>
    </div>
</div>
...
<div class="info-box tip">
    ...
    <div>
        ...
        <p>VSCode + AI kombinasyonunda terminal tabanlı giriş bozuluyorsa, `pinentry-gtk` hayat kurtarıyor. Artık şifreyi eksiksiz ve sorunsuz girebilirsiniz.</p>
    </div>
</div>
...
<div class="info-box warning">
    ...
    <div>
        ...
        <p>Sık yapılan hata: Commit’i attıktan sonra GitHub’da görememek. Bunun nedeni push yapmayı unutmanızdır.</p>
    </div>
</div>
...
<div class="info-box note">
    ...
    <div>
        ...
        <p>`default-cache-ttl` ayarı sayesinde aynı gün içinde defalarca commit atsanız bile şifreyi her seferinde sormaz.</p>
    </div>
</div>
