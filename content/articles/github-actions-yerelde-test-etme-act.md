...
Eğer Arch Linux kullanıyorsanız (ki benim gibi bir Arch aşığıysanız muhtemelen öyledir), [Arch Linux Docker kurulumu](file:///content/articles/arch-linux-docker-kurulumu.md) yazıma bir göz atın derim. Orada her şeyi detaylıca anlattım, eksiksiz kurun ki `act` naz yapmasın.
...
!!! tip "İpucu ⚡"
    İlk imaj indirme işlemi biraz sürebilir (birkaç GB olabilir). Bir kahve alın, gelin. Sabır, bu işin anahtarı.
...
!!! warning "Dikkat! ⚠️"
    ...
    Sakın ha bu `.secrets` dosyasını yanlışlıkla git'e pushlamayın, sonra [git ssh key oluşturma](file:///content/articles/git-ssh-key-olusturma.md) yazımda anlattığım o güvenlik önlemleri boşa gider.
...
### İlgili Yazılar:
- [GitHub Commit Atma Rehberi](file:///content/articles/github-commit-atma-rehberi.md)
- [Arch Linux Docker Kurulumu](file:///content/articles/arch-linux-docker-kurulumu.md)
- [Git SSH Key Oluşturma](file:///content/articles/git-ssh-key-olusturma.md)
